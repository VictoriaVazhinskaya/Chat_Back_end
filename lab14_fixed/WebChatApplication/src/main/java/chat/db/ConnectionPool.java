...
public class ConnectionPool {
    ...
    private static final String URL = "jdbc:mysql://localhost:3306/chat2";
    private static final String DRIVER = "com.mysql.jdbc.Driver";
    private static final String USERNAME = "PatrickStar";
    private static final String PASSWORD = "yVrunGle9Polo210";
